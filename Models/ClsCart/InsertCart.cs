            ...
            /*{
                ...
                if (cid != null)
                {
                    ...
                    if (price >= 1)
                    {
                        ...
                        if (x >= 1)
                        {
                            string query6 = "INSERT INTO OrderProduct (ProductId,Qty,UnitPrice,Amount,CreatedBy,CreatedAt,UpdatedBy,UpdatedAt,DeletedBy,DeletedAt) " +
                                            "SELECT ProductId, Qty, UnitPrice, Amount, CreatedBy, CreatedAt, UpdatedBy, UpdatedAt, DeletedBy, DeletedAt FROM CartItem " +
